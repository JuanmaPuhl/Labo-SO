...
/**
    Enunciado: Los procesos P2 hasta P4 colaboran con el proceso P1 para que pueda realizar
    todo el trabajo. P2, P3 y P4 se ejecutan concurrentemente. Las actividades que se realizan
    en las tareas son las siguientes:
    Tarea 1: Ingresar o asignar valores a 2 vectores de 6 elementos.
    Tarea 2: Cada proceso obtiene la suma de dos elementos correspondientes. El resultado de la
    suma lo guarda en un archivo.
    Tarea 3: Muestra por pantalla la suma de los vectores.
*/
int main(){
